module neural_network (
    ...
    // Image memory write port
    input wire [15:0] image_write_addr,
    ...
    image_memory input_mem(
        ...
        .data_out(input_data),
        .write_address(image_write_addr),
        .write_data(image_write_data),
        .write_enable(image_write_en)
    );
    ...
    assign next_state = r_next_state;
    ...
    // Output assignment
    assign done = (r_current_state == DONE);
